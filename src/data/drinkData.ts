...
export const DRINK_ITEMS: DrinkItem[] = [
  { id: 'chamisul', title: '참이슬', description: '', price: '5,000원', image: '주류-참이슬.png', category: 'DRINK' },
  { id: 'cheoeum', title: '처음처럼', description: '', price: '5,000원', image: '주류-처음처럼.png', category: 'DRINK' },
  { id: 'jinro', title: '진로', description: '', price: '5,000원', image: '주류-진로.png', category: 'DRINK' },
  { id: 'saero', title: '새로', description: '', price: '5,000원', image: '주류-새로.png', category: 'DRINK' },
  { id: 'cheongha', title: '청하', description: '', price: '6,000원', image: '주류-청하.png', category: 'DRINK' },
  { id: 'tonic', title: '토닉워터', description: '', price: '2,000원', image: '주류-토닉워터.png', category: 'DRINK' },
  ...
  { id: 'cass', title: '카스', description: '', price: '5,000원', image: '주류-카스.png', category: 'BEER' },
  { id: 'terra', title: '테라', description: '', price: '5,000원', image: '주류-테라.png', category: 'BEER' },
  { id: 'hoegaarden', title: '호가든', description: '수제맥주입문자, 부드러운 맛', price: '6,000원', image: '주류-호가든.png', category: 'BEER' },
  { id: 'stella', title: '스텔라', description: '청량한 산미, 깔끔한 맛', price: '7,000원', image: '주류-스텔라.png', category: 'BEER' },
  {
    id: 'kozel-dark',
    title: '코젤다크',
